...
export const UI = {
  ...
  nav: {
    ...
    updates: text("最新動態", "Latest updates", { ja: "最新の動き", ko: "최신 업데이트", es: "Últimas novedades", fr: "Dernières nouvelles", de: "Neueste Updates", pt: "Atualizações", ar: "آخر التحديثات", hi: "नवीनतम अपडेट", it: "Ultimi aggiornamenti" }),
  },
  home: {
    ...
    greetings: {
      morning: text("早安 祝你有美好的一天~", "Good morning. Have a wonderful day ahead.", { ja: "おはようございます。素晴らしい一日になりますように。", ko: "좋은 아침입니다. 오늘 하루도 즐겁게 보내세요.", es: "Buenos días. Que tengas un día maravilloso.", fr: "Bonjour. Passez une excellente journée.", de: "Guten Morgen. Ich wünsche dir einen wundervollen Tag.", pt: "Bom dia. Tenha um dia maravilhoso.", ar: "صباح الخير. أتمنى لك يوماً رائعاً.", hi: "सुप्रभात। आपका दिन मंगलमय हो।", it: "Buongiorno. Ti auguro una splendida giornata." }),
      afternoon: text("午安 要吃飽才有力氣繼續下午的工作", "Good afternoon. Fuel up for the rest of your day.", { ja: "こんにちは。午後も元気に頑張りましょう。", ko: "좋은 오후입니다. 든든하게 드시고 오후 업무도 화이팅하세요.", es: "Buenas tardes. Recarga energías para el resto del día.", fr: "Bon après-midi. Prenez des forces pour la suite de la journée.", de: "Guten Tag. Tanke Kraft für den Rest des Tages.", pt: "Boa tarde. Recarregue as energias para o resto do dia.", ar: "مساء الخير. استعد لبقية يومك.", hi: "नमस्कार। अपने शेष दिन के लिए ऊर्जा जुटाएं।", it: "Buon pomeriggio. Ricaricati per il resto della giornata." }),
      evening: text("晚安 好好休息~也可以看看我的日誌", "Good evening. Rest well—perhaps read through my journals.", { ja: "こんばんは。ゆっくり休んでくださいね。よろしければ日誌もどうぞ。", ko: "좋은 저녁입니다. 편안한 밤 되세요. 제 저널도 한번 둘러보세요.", es: "Buenas noches. Descansa bien, tal vez quieras leer mis diarios.", fr: "Bonsoir. Reposez-vous bien—pourquoi ne pas lire mes journaux ?", de: "Guten Abend. Ruh dich gut aus – vielleicht magst du in meinen Journalen lesen.", pt: "Boa noite. Descanse bem — talvez queira ler os meus diários.", ar: "مساء الخير. ارتح جيداً، وربما تطلع على يومياتي.", hi: "शुभ संध्या। आराम करें—शायద मेरी पत्रिकाओं को पढ़ें。 ", it: "Buonasera. Riposati bene, magari leggi i miei diari." }),
      night: text("凌晨好 不知道你是早起還是晚睡，願你有好的心情，壓力不要太大", "Hello there in the quiet hours. Whether you're up early or late, I wish you peace of mind.", { ja: "深夜にこんばんは。早起きの方も夜更かしの方も、穏やかな時間になりますように。", ko: "이른 새벽이네요. 일찍 일어나셨든 늦게 주무시든, 평온한 마음이길 바랍니다.", es: "Hola en estas horas tranquilas. Ya sea que te hayas levantado temprano o te acuestes tarde, te deseo paz mental.", fr: "Bonjour en ces heures paisibles. Que vous soyez matinal ou couche-tard, je vous souhaite de la sérénité.", de: "Hallo in den stillen Stunden. Egal, ob du früh aufgestanden oder noch wach bist, ich wünsche dir innere Ruhe.", pt: "Olá nestas horas tranquilas. Quer tenha acordado cedo ou se deite tarde, desejo-lhe paz de espírito.", ar: "مرحباً في هذه الساعات الهادئة。سواء كنت مستيقظاً باكراً أو متأخراً，أتمنى لك راحة البال。", hi: "इन शांत घंटों में नमस्कार。चाहे आप जल्दी उठे हों या देर से सोए हों，मैं आपके मानसिक शांति की कामना करता हूँ。", it: "Ciao in queste ore tranquille。Che tu sia mattiniero o nottambulo，ti auguro pace mentale。" }),
    },
  },
  actions: {
  ...
  pages: {
    ...
    updates: {
      title: text("最新動態", "Latest updates", { ja: "最新の動き", ko: "최신 업데이트", es: "Últimas novedades", fr: "Dernières nouvelles", de: "Neueste Updates", pt: "Atualizações", ar: "آخر التحديثات", hi: "नवीनतम अपडेट", it: "Ultimi aggiornamenti" }),
      intro: text("把工房最近的畫面留下來。圖片與影片會依時間由新到舊排列。", "A visual stream from the workshop, arranged from newest to oldest.", { ja: "工房の最近の風景を残します。画像と動画は新しい順に並びます。", ko: "공방의 최근 장면을 남깁니다. 이미지와 영상은 최신순으로 정렬됩니다.", es: "Un flujo visual del taller, ordenado de lo más reciente a lo más antiguo.", fr: "Un fil visuel de l’atelier, du plus récent au plus ancien.", de: "Ein visueller Strom aus der Werkstatt, vom neuesten zum ältesten Eintrag.", pt: "Um fluxo visual da oficina, do mais recente ao mais antigo.", ar: "تدفق بصري من الورشة، مرتب من الأحدث إلى الأقدم.", hi: "कार्यशाला की दृश्य धारा, नवीनतम से पुराने क्रम में।", it: "Un flusso visivo dall’officina, dal più recente al più vecchio." }),
      empty: text("目前還沒有最新動態。把圖片或影片放進 GitHub 的 `public/updates` 資料夾後，這裡會自動出現。", "No updates yet. Add an image or video to the GitHub `public/updates` folder and it will appear here after deployment.", { ja: "まだ最新の動きはありません。GitHub の `public/updates` フォルダに画像や動画を追加すると、デプロイ後にここへ表示されます。", ko: "아직 업데이트가 없습니다. GitHub의 `public/updates` 폴더에 이미지나 영상을 추가하면 배포 후 여기에 표시됩니다.", es: "Aún no hay novedades. Añade una imagen o vídeo a `public/updates` en GitHub y aparecerá después del despliegue.", fr: "Aucune nouveauté pour le moment. Ajoutez une image ou une vidéo dans `public/updates` sur GitHub pour l’afficher après le déploiement.", de: "Noch keine Updates. Füge ein Bild oder Video in `public/updates` auf GitHub hinzu; es erscheint nach dem Deployment.", pt: "Ainda não há atualizações. Adicione uma imagem ou vídeo à pasta `public/updates` no GitHub e aparecerá após a publicação.", ar: "لا توجد تحديثات بعد. أضف صورة أو فيديو إلى مجلد `public/updates` في GitHub وسيظهر بعد النشر.", hi: "अभी कोई अपडेट नहीं है। GitHub के `public/updates` फ़ोल्डर में छवि या वीडियो जोड़ें; परिनियोजन के बाद यह यहाँ दिखाई देगा।", it: "Ancora nessun aggiornamento. Aggiungi un’immagine o un video nella cartella `public/updates` su GitHub e apparirà dopo il deploy." }),
      guide: text("上傳規則", "Upload pattern", { ja: "アップロード形式", ko: "업로드 형식", es: "Formato de carga", fr: "Format d’envoi", de: "Upload-Format", pt: "Formato de envio", ar: "نمط الرفع", hi: "अपलोड प्रारूप", it: "Formato di caricamento" }),
      count: text("則動態", "updates", { ja: "件", ko: "개", es: "novedades", fr: "mises à jour", de: "Updates", pt: "atualizações", ar: "تحديثات", hi: "अपडेट", it: "aggiornamenti" }),
    },
    about: {
